...
const MainSlider = (props) => {
  ...
  const items = [
    {
      src: require('assets/images/carousel-notfound-1-mobile.jpg'),
      altText: 'Slide 1',
      contain: {
        title: t("main-slider-section.slide.title"),
        subtitle: t("main-slider-section.slide.subtitle"),
        button: [
          { 
            label: t("main-slider-section.slide.button-1"),
            link: "/",
            icon: ""
          }
        ]
          ...
          <div className="section-absolute">
            <Container>
              <div className="item-text">
                {item.contain.title ? <h2 className="title" style={{width:'80%'}}>{item.contain.title}</h2> : null}
