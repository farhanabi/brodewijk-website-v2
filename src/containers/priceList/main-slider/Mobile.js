...
const MainSlider = (props) => {
  ...
  const items = [
    {
      src: require('assets/images/carousel-pricelist-1-mobile.jpg'),
      altText: 'Slide 1',
      contain: {
  ...
  const slides = items.map((item) => {
    return (
      ...
      >
          ...
          <div className="section-absolute">
            <Container>
              <div className="item-text">
                <h6 className="page-title">{t("special-discount")}</h6>
        ...
        <img src={item.src} alt={item.altText} style={{paddingTop:'50px'}}/>
      </CarouselItem>
    );
  });
