  ...
  const items = [
    {
      ...
      contain: {
        ...
        button: [
          ...
          { label: t("main-slider-section.button-2"), link: "https://www.brodewijk.com/price-list", icon: "" },
          ...
          { label: t("main-slider-section.button-5"), link: "https://shopee.co.id/brodewijk", icon: ""},
          { label: t("main-slider-section.button-6"), link: "https://www.tokopedia.com/brodewijkid", icon: ""}
        ]
      }
    }
  ];
