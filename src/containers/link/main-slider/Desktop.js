  ...
  const items = [
    {
      ...
      contain: {
        ...
        button: [
          ...
          { label: t("main-slider-section.button-2"), link: "https://contactmainclothes.wixsite.com/mysite", newtab: true, icon: "" },
          ...
          { label: t("main-slider-section.button-6"), link: "https://www.brodewijk.com", newtab: true, icon: ""}
