...
const MainSlider = (props) => {
  ...
  const items = [
    {
      src: require('assets/images/carousel-sizeguide-1-desktop.jpg'),
      altText: 'Slide 1',
      contain: {
        title: t("main-slider-section.slide-1.title"),
        subtitle: t("main-slider-section.slide-1.subtitle"),
        button: [
          { label: t("main-slider-section.slide-1.button-1"), linkScroll: "size-section", icon: "" },
          { label: t("main-slider-section.slide-1.button-2"), link: "https://calendly.com/brodewijk-bookappointment/pengukuran-jas", icon: "" }
        ]
        }
    }
  ];
