...
function Measurement(props) {
  ...
  const validationSchema = yup.object({
    ...
    frontLength: yup.string()
      .required('Front length is required'),
    ...
    armpits: yup.string()
      .required('Armpits is required'),
    biceps: yup.string()
      .required('Biceps is required'),
    wrist: yup.string()
      .required('Wrist is required'),
    frontChest: yup.string()
      .required('Front chest is required'),
    backChest: yup.string()
      .required('Back chest is required')
  });
    ...
    <div className="measure-mobile">
      ...
      <Row className="fit">
        ...
        <Col xs={4} className="pr-0">
          <Button
            className={`btn-tab full-width ${classnames({ active: fit === 'regular' })}`}
      ...
      <Row className="method">
        ...
        <Col xs={4} className="pr-0">
          <Button
            className={`btn-tab full-width ${classnames({ active: method === 'standard' })}`}
      ...
      <TabContent activeTab={method}>
        ...
        <TabPane tabId="custom" className="custom">
          ...
          {formik => {
            ...
            return (
              <>
                <h5 className="subtitle">{t("custom-measurement.body-measurement.title")}</h5>
                ...
                <Row>
                  ...
                  <Col xs={6}>
                    <FormGroup>
                      ...
                      <Input type="text" placeholder="cm"
                        onChange={handleChange("heihipsght")}
